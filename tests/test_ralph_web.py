...
class HttpSurfaceTests(unittest.TestCase):
    ...
    def test_index_contains_operator_sections_and_csrf_token(self):
        ...
        human = page.index('<h2>Human Control</h2>')
        ...
        self.assertIn('<span>Steers</span>', page)
        self.assertIn('control_stats_status', page)
        self.assertIn('Legacy plan · plan-bound control history unavailable', page)
